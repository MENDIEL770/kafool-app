...
const FAQ_DEFAULTS: FaqItem[] = [
  { id: 'd1', question: 'מה זה ׳כפול׳?', answer: 'כפול היא פלטפורמה לניהול קמפייני גיוס תרומות. היא מאפשרת לארגונים, מוסדות ויחידים לבנות דף קמפיין מקצועי, לקבל תרומות באופן מאובטח ולנהל את כל התהליך ממקום אחד.', sort_order: 0, is_active: true },
