  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 overflow-x-clip" dir="rtl" style={pageBg ? { backgroundColor: pageBg } : undefined}>
      ...
      {mounted && whatsappUrl && createPortal((
        ...
        // the other side. The layer is click-through (pointer-events:none) except
        // the button itself, and the button never uses a transform/transition.
        <div dir="ltr" style={{ position: 'fixed', inset: 0, zIndex: 70, pointerEvents: 'none' }}>
        <a
          href={whatsappUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="absolute w-14 h-14 rounded-full flex items-center justify-center shadow-xl"
          style={{
