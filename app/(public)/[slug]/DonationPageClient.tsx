  ...
  return (
    ...
    >
      <defs>
        ...
        <style>{`
          @keyframes kafoolHeaderLoop {
            0%   { stroke-dashoffset: 0; }
            100% { stroke-dashoffset: -1400; }
          }
          @keyframes kafoolHeaderIn {
            0%   { opacity: 0; }
            100% { opacity: 1; }
          }
        `}</style>
      ...
      {/* סמל — fill */}
      <path fill="rgb(94.5%,36.9%,30.2%)" d={SYMBOL_PATH} />
      ...
      <path
        ...
        strokeDashoffset="0"
        style={{ animation: 'kafoolHeaderLoop 1.4s linear infinite' }}
        d={SYMBOL_PATH}
      />

      {/* אותיות כ א פ ל */}
      <g fill="rgb(25.1%,42%,70.6%)"><use xlinkHref="#hg3" x="421.282518" y="326.941531"/></g>
      <g fill="rgb(25.1%,42%,70.6%)"><use xlinkHref="#hg2" x="226.182145" y="326.941531"/></g>
      <g fill="rgb(25.1%,42%,70.6%)"><use xlinkHref="#hg1" x="154.914132" y="326.941531"/></g>
      <g fill="rgb(25.1%,42%,70.6%)"><use xlinkHref="#hg0" x="93.088881"  y="326.941531"/></g>
    </svg>
  )
}
