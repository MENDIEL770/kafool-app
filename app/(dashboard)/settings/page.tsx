...
export default async function SettingsPage() {
  ...
  const org = (profile as { organizations?: { name: string; slug: string; registration_number?: string; receipt_name?: string } }).organizations
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium" dir="ltr">kafool.com/{org.slug}</span>
            </div>
